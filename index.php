            ...
            <div class="col-lg-12">
              <div class="banner_content text-center">
                <p class="text-uppercase">
                  MEILLEUR SERVICE D'ÉDUCATION EN LIGNE AU MONDE
                </p>
                <h2 class="text-uppercase mt-4 mb-5">
               UN PAS EN AVANT CETTE SAISON
                </h2>
                <div>
                  <a href="login.php" class="primary-btn2 mb-3 mb-sm-0">EN SAVOIR PLUS</a>
                  <a href="#" class="primary-btn ml-sm-3 ml-0">VOIR LE COURS</a>
                </div>
              </div>
            </div>
          </div>
...
<div id="myModal" class="modal fade">
    ...
    <div id="logreg-forms">
        <form class="form-signin" action="authentifier.php" method="POST">
            ...
            <div class="input-group">
              <button class="btn btn-md btn-rounded btn-block form-control submit" name="valider"  type="submit"><i class="fas fa-sign-in-alt"></i> S'authentifier</button>
            </div>
 ...
 <form class="form-signup"  action="index.php" method="POST" enctype="multipart/form-data" >
