...
<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-T8Gy5hrqNKT+hzMclPo118YTQO6cYprQmhrYwIiQ/3axmI1hQomh7Ud2hPOy8SP1" crossorigin="anonymous">
  ...
  <li class="#"><a href="index.php"><i class='fas fa-home' style='font-size:36px'></i><span class="hidden-xs hidden-sm">Home</span></a></li>
                       
                        <li><a href="Etudiant.php"><i class='fas fa-user-graduate' style='font-size:36px'></i><span>Etudiant</span></a></li>
                        <li><a href="professeur.php"><i class='fas fa-chalkboard-teacher' style='font-size:36px'></i><span>Professeur</span></a></li>
                       
                         <li><a href="filière.php"><i class="fa fa-sitemap" style="font-size:36px"></i><span class="hidden-xs hidden-sm">Filière</span></a></li>

                        <li><a href="notif.php"><i class="material-icons" style="font-size:36px">&#xe159;</i>
<span class="hidden-xs hidden-sm">Réclamation</span></a></li>
                        <li><a href="#"><i class="fa fa-cog" style="font-size:36px;"></i><span class="hidden-xs hidden-sm">Paramètre</span></a></li>
    ...
    <section class="codepen-style">
       <a href="blog.php"> <h1><span>Admin</span>istrateur</h1> </a>
